...
def add_page_selector():
    ...
    st.page_link("pages/add_statistics.py", label="Add Statistics")
    st.page_link("pages/add_shots.py", label="Add Shots")
    st.page_link("pages/discover_incidents.py", label="Discover Incidents")
